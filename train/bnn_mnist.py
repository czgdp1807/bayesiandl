...
def train(input_data_path, target_data_path, weight_file, batch_size=1, epochs=1,
          cache_result=True, use_cache=False):
    inputs = read_idx(input_data_path, True, True, True, 10000, False, cache_result, use_cache)
    targets = read_idx(target_data_path, False, False, True, 10000, True, cache_result, use_cache)
